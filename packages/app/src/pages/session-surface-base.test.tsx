...
beforeAll(async () => {
  ...
  mock.module("@solid-primitives/resize-observer", () => ({ createResizeObserver: noop }))
  ...
  mock.module("@/context/layout", () => ({
    useLayout: () => ({
      ...
      view: () => ({
        ...
        reviewPanel: { opened: () => false, open: noop, toggle: noop },
  ...
  mock.module("@/context/sync", () => ({
    useSync: () => ({
      status: "complete",
      project: undefined,
      data: { vcs: {}, session_status: {}, part: {}, message: {}, todo: {} },
      session: {
        get: () => undefined,
        remember: noop,
...
describe("SessionSurfaceBase", () => {
  ...
  test("scopes messages, composer, and terminal container ids per surface", () => {
    mount(() => (
      <>
        <SessionSurfaceBase target={{ sessionID: "sess-1" }} surfaceID="s1" />
        <SessionSurfaceBase target={{ sessionID: "sess-2" }} surfaceID="s2" />
      </>
    ))
  ...
  test("mounts two surfaces for the same session without id collisions", () => {
    const host = mount(() => (
      <>
        <SessionSurfaceBase target={{ sessionID: "sess-shared" }} surfaceID="s1" />
        <SessionSurfaceBase target={{ sessionID: "sess-shared" }} surfaceID="s2" />
      </>
    ))
