export const dict = {
  ...
  "canvas.model.refresh": "Обновить модели",
  "canvas.model.refreshing": "Обновление моделей…",
  "canvas.model.refresh.error": "Не удалось обновить модели. Существующие модели по-прежнему доступны.",
  "canvas.model.picker.ariaLabel": "{{label}}: выбор модели",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Выберите модель OperatingAgent, чтобы начать эту сессию.",
  "canvas.operatingAgent.starting": "Запуск сессии OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Сессия недоступна",
  "canvas.operatingAgent.retry": "Повторить попытку",
