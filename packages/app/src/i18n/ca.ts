export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Selector de models de {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Selecciona un model d'OperatingAgent per iniciar aquesta sessió.",
  "canvas.operatingAgent.starting": "S'està iniciant la sessió d'OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Sessió no disponible",
  "canvas.operatingAgent.retry": "Torna-ho a intentar",
