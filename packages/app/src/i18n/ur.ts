export const dict = {
  "canvas.model.refresh": "ماڈلز تازہ کریں",
  "canvas.model.refreshing": "ماڈلز تازہ کیے جا رہے ہیں…",
  "canvas.model.refresh.error": "ماڈلز تازہ نہیں کیے جا سکے۔ موجودہ ماڈلز اب بھی دستیاب ہیں۔",
  "canvas.model.picker.ariaLabel": "{{label}} ماڈل چنندہ",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "اس سیشن کو شروع کرنے کے لیے OperatingAgent ماڈل منتخب کریں۔",
  "canvas.operatingAgent.starting": "OperatingAgent سیشن شروع ہو رہا ہے...",
  "canvas.operatingAgent.unavailable": "سیشن دستیاب نہیں",
  "canvas.operatingAgent.retry": "دوبارہ کوشش کریں",
