export const dict = {
  ...
  "canvas.model.refresh": "Muat semula model",
  "canvas.model.refreshing": "Memuat semula model…",
  "canvas.model.refresh.error": "Tidak dapat memuat semula model. Model sedia ada masih tersedia.",
  "canvas.model.picker.ariaLabel": "Pemilih model {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Pilih model OperatingAgent untuk memulakan sesi ini.",
  "canvas.operatingAgent.starting": "Memulakan sesi OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Sesi tidak tersedia",
  "canvas.operatingAgent.retry": "Cuba semula",
