export const dict: Record<string, string> = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} དཔེ་ཚད་སེལ་འཐུ་འབད་མི།",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "ལཱ་ཡུན་འདི་འགོ་བཙུགས་ནིའི་དོན་ལུ་ OperatingAgent དཔེ་ཚད་ཅིག་སེལ་འཐུ་འབད།",
  "canvas.operatingAgent.starting": "OperatingAgent ལཱ་ཡུན་འགོ་བཙུགས་དོ...",
  "canvas.operatingAgent.unavailable": "ལཱ་ཡུན་ཐོབ་མི་ཚུགས།",
  "canvas.operatingAgent.retry": "ལོག་འབད་རྩོལ་བསྐྱེད།",
