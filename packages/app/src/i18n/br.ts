export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Seletor de modelos de {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Selecione um modelo do OperatingAgent para iniciar esta sessão.",
  "canvas.operatingAgent.starting": "Iniciando sessão do OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Sessão indisponível",
  "canvas.operatingAgent.retry": "Tentar novamente",
