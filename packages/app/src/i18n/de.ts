...
export const dict = {
  ...
  "canvas.model.refresh.error":
    "Modelle konnten nicht aktualisiert werden. Die vorhandenen Modelle sind weiterhin verfügbar.",
  "canvas.model.picker.ariaLabel": "{{label}}-Modellauswahl",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Wählen Sie ein OperatingAgent-Modell aus, um diese Sitzung zu starten.",
  "canvas.operatingAgent.starting": "OperatingAgent-Sitzung wird gestartet...",
  "canvas.operatingAgent.unavailable": "Sitzung nicht verfügbar",
  "canvas.operatingAgent.retry": "Erneut versuchen",
