export const dict: Record<string, string> = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} মডেল নির্বাচক",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "এই সেশন শুরু করতে একটি OperatingAgent মডেল নির্বাচন করুন।",
  "canvas.operatingAgent.starting": "OperatingAgent সেশন শুরু হচ্ছে...",
  "canvas.operatingAgent.unavailable": "সেশন উপলভ্য নয়",
  "canvas.operatingAgent.retry": "আবার চেষ্টা করুন",
