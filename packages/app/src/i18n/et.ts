export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} mudelivalija",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Valige selle seansi alustamiseks OperatingAgent mudel.",
  "canvas.operatingAgent.starting": "OperatingAgent seansi käivitamine...",
  "canvas.operatingAgent.unavailable": "Seanss pole saadaval",
  "canvas.operatingAgent.retry": "Proovi uuesti",
