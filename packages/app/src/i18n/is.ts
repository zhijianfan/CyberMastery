...
export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Líkanaval fyrir {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Veldu OperatingAgent-líkan til að hefja þessa setu.",
  "canvas.operatingAgent.starting": "Ræsi OperatingAgent-setu...",
  "canvas.operatingAgent.unavailable": "Seta ekki tiltæk",
  "canvas.operatingAgent.retry": "Reyna aftur",
