export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Селектор на модели за {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Изберете модел на OperatingAgent, за да стартирате тази сесия.",
  "canvas.operatingAgent.starting": "Стартиране на сесия на OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Сесията не е налична",
  "canvas.operatingAgent.retry": "Опитайте отново",
