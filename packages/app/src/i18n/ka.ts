export const dict = {
  ...
  "canvas.model.refresh": "მოდელების განახლება",
  "canvas.model.refreshing": "მოდელები ახლდება…",
  "canvas.model.refresh.error": "მოდელების განახლება ვერ მოხერხდა. არსებული მოდელები კვლავ ხელმისაწვდომია.",
  "canvas.model.picker.ariaLabel": "{{label}} მოდელის ამომრჩეველი",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "აირჩიეთ OperatingAgent მოდელი ამ სესიის დასაწყებად.",
  "canvas.operatingAgent.starting": "OperatingAgent სესია იწყება...",
  "canvas.operatingAgent.unavailable": "სესია მიუწვდომელია",
  "canvas.operatingAgent.retry": "ხელახლა ცდა",
