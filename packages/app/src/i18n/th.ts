export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "ตัวเลือกโมเดลของ {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "เลือกโมเดล OperatingAgent เพื่อเริ่มเซสชันนี้.",
  "canvas.operatingAgent.starting": "กำลังเริ่มเซสชัน OperatingAgent...",
  "canvas.operatingAgent.unavailable": "เซสชันไม่พร้อมใช้งาน",
  "canvas.operatingAgent.retry": "ลองอีกครั้ง",
