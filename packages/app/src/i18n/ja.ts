export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}}モデルセレクター",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "このセッションを開始するには、OperatingAgentモデルを選択してください。",
  "canvas.operatingAgent.starting": "OperatingAgentセッションを開始中...",
  "canvas.operatingAgent.unavailable": "セッションは利用できません",
  "canvas.operatingAgent.retry": "再試行",
