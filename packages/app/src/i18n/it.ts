export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Selettore del modello {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Seleziona un modello OperatingAgent per avviare questa sessione.",
  "canvas.operatingAgent.starting": "Avvio della sessione OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Sessione non disponibile",
  "canvas.operatingAgent.retry": "Riprova",
