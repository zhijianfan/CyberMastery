export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} model seçicisi",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Bu sessiyanı başlatmaq üçün OperatingAgent modeli seçin.",
  "canvas.operatingAgent.starting": "OperatingAgent sessiyası başladılır...",
  "canvas.operatingAgent.unavailable": "Sessiya əlçatan deyil",
  "canvas.operatingAgent.retry": "Yenidən cəhd et",
