export const dict = {
  ...
  "canvas.model.refresh": "Osveži modele",
  "canvas.model.refreshing": "Osveževanje modelov…",
  "canvas.model.refresh.error": "Modelov ni bilo mogoče osvežiti. Obstoječi modeli so še vedno na voljo.",
  "canvas.model.picker.ariaLabel": "Izbirnik modela {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Izberite model OperatingAgent za začetek te seje.",
  "canvas.operatingAgent.starting": "Zaganjanje seje OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Seja ni na voljo",
  "canvas.operatingAgent.retry": "Poskusi znova",
