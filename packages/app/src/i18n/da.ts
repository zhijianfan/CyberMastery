export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} modelvælger",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Vælg en OperatingAgent-model for at starte denne session.",
  "canvas.operatingAgent.starting": "Starter OperatingAgent-session...",
  "canvas.operatingAgent.unavailable": "Session ikke tilgængelig",
  "canvas.operatingAgent.retry": "Prøv igen",
