export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} मॉडल पिकर",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "इस सेशन को शुरू करने के लिए OperatingAgent मॉडल चुनें।",
  "canvas.operatingAgent.starting": "OperatingAgent सेशन शुरू हो रहा है...",
  "canvas.operatingAgent.unavailable": "सेशन उपलब्ध नहीं है",
  "canvas.operatingAgent.retry": "पुनः प्रयास करें",
