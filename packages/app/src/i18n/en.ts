...
export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} model picker",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Select an OperatingAgent model to start this session.",
  "canvas.operatingAgent.starting": "Starting OperatingAgent session...",
  "canvas.operatingAgent.unavailable": "Session unavailable",
  ...
  "workspace.environment.environment.label": "Layout",
