...
export const dict = {
  ...
  "canvas.operatingAgent.unconfigured": "Bu oturumu başlatmak için bir OperatingAgent modeli seçin.",
  "canvas.operatingAgent.starting": "OperatingAgent oturumu başlatılıyor...",
  "canvas.operatingAgent.unavailable": "Oturum kullanılamıyor",
  "canvas.operatingAgent.retry": "Yeniden dene",
