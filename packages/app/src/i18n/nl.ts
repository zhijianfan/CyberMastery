export const dict = {
  ...
  "canvas.model.refresh": "Modellen vernieuwen",
  "canvas.model.refreshing": "Modellen worden vernieuwd…",
  "canvas.model.refresh.error":
    "Modellen konden niet worden vernieuwd. De bestaande modellen zijn nog steeds beschikbaar.",
  "canvas.model.picker.ariaLabel": "{{label}}-modelkiezer",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Selecteer een OperatingAgent-model om deze sessie te starten.",
  "canvas.operatingAgent.starting": "OperatingAgent-sessie starten...",
  "canvas.operatingAgent.unavailable": "Sessie niet beschikbaar",
  "canvas.operatingAgent.retry": "Opnieuw proberen",
