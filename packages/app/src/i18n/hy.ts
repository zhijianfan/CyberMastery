export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} մոդելի ընտրիչ",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Ընտրեք OperatingAgent մոդել՝ այս նիստը սկսելու համար։",
  "canvas.operatingAgent.starting": "Սկսվում է OperatingAgent նիստը...",
  "canvas.operatingAgent.unavailable": "Նիստն անհասանելի է",
  "canvas.operatingAgent.retry": "Կրկին փորձել",
