export const dict = {
  ...
  "canvas.model.refresh": "Atsvaidzināt modeļus",
  "canvas.model.refreshing": "Atsvaidzina modeļus…",
  "canvas.model.refresh.error": "Neizdevās atsvaidzināt modeļus. Esošie modeļi joprojām ir pieejami.",
  "canvas.model.picker.ariaLabel": "{{label}} modeļa atlasītājs",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Izvēlieties OperatingAgent modeli, lai sāktu šo sesiju.",
  "canvas.operatingAgent.starting": "Sāk OperatingAgent sesiju...",
  "canvas.operatingAgent.unavailable": "Sesija nav pieejama",
  "canvas.operatingAgent.retry": "Mēģināt vēlreiz",
