...
export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Modellvelger for {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Velg en OperatingAgent-modell for å starte denne sesjonen.",
  "canvas.operatingAgent.starting": "Starter OperatingAgent-sesjon...",
  "canvas.operatingAgent.unavailable": "Sesjonen er utilgjengelig",
  "canvas.operatingAgent.retry": "Prøv igjen",
