...
export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Birač modela za {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Odaberite model OperatingAgent za pokretanje ove sesije.",
  "canvas.operatingAgent.starting": "Pokretanje sesije OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Sesija nije dostupna",
  "canvas.operatingAgent.retry": "Pokušaj ponovno",
