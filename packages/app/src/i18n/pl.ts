export const dict = {
  ...
  "canvas.model.refresh": "Odśwież modele",
  "canvas.model.refreshing": "Odświeżanie modeli…",
  "canvas.model.refresh.error": "Nie udało się odświeżyć modeli. Istniejące modele są nadal dostępne.",
  "canvas.model.picker.ariaLabel": "Selektor modelu {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Wybierz model OperatingAgent, aby rozpocząć tę sesję.",
  "canvas.operatingAgent.starting": "Rozpoczynanie sesji OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Sesja niedostępna",
  "canvas.operatingAgent.retry": "Spróbuj ponownie",
