export const dict = {
  ...
  "canvas.model.refresh": "Reîmprospătează modelele",
  "canvas.model.refreshing": "Se reîmprospătează modelele…",
  "canvas.model.refresh.error":
    "Nu s-au putut reîmprospăta modelele. Modelele existente sunt în continuare disponibile.",
  "canvas.model.picker.ariaLabel": "Selector de modele pentru {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Selectează un model OperatingAgent pentru a începe această sesiune.",
  "canvas.operatingAgent.starting": "Se pornește sesiunea OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Sesiune indisponibilă",
  "canvas.operatingAgent.retry": "Reîncearcă",
