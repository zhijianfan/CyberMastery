export const dict = {
  ...
  "canvas.model.refresh.error":
    "Δεν ήταν δυνατή η ανανέωση των μοντέλων. Τα υπάρχοντα μοντέλα εξακολουθούν να είναι διαθέσιμα.",
  "canvas.model.picker.ariaLabel": "Επιλογέας μοντέλου {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Επιλέξτε ένα μοντέλο OperatingAgent για να ξεκινήσετε αυτήν τη συνεδρία.",
  "canvas.operatingAgent.starting": "Εκκίνηση συνεδρίας OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Η συνεδρία δεν είναι διαθέσιμη",
  "canvas.operatingAgent.retry": "Δοκιμάστε ξανά",
