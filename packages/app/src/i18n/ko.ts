export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} 모델 선택기",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "이 세션을 시작하려면 OperatingAgent 모델을 선택하세요.",
  "canvas.operatingAgent.starting": "OperatingAgent 세션 시작 중...",
  "canvas.operatingAgent.unavailable": "세션을 사용할 수 없음",
  "canvas.operatingAgent.retry": "다시 시도",
