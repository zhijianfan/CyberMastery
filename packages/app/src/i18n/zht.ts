...
export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} 模型選擇器",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "選擇 OperatingAgent 模型以開始此工作階段。",
  "canvas.operatingAgent.starting": "正在啟動 OperatingAgent 工作階段...",
  "canvas.operatingAgent.unavailable": "工作階段無法使用",
  "canvas.operatingAgent.retry": "重試",
