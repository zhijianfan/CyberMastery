export const dict = {
  ...
  "canvas.model.refresh": "Modellarni yangilash",
  "canvas.model.refreshing": "Modellar yangilanmoqda…",
  "canvas.model.refresh.error": "Modellarni yangilab bo‘lmadi. Mavjud modellar hali ham foydalanish mumkin.",
  "canvas.model.picker.ariaLabel": "{{label}} modeli tanlagichi",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Ushbu seansni boshlash uchun OperatingAgent modelini tanlang.",
  "canvas.operatingAgent.starting": "OperatingAgent seansi boshlanmoqda...",
  "canvas.operatingAgent.unavailable": "Seans mavjud emas",
  "canvas.operatingAgent.retry": "Qaytadan urinish",
