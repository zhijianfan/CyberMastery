export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}}-mallivalitsin",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Valitse OperatingAgent-malli aloittaaksesi tämän istunnon.",
  "canvas.operatingAgent.starting": "Käynnistetään OperatingAgent-istuntoa...",
  "canvas.operatingAgent.unavailable": "Istunto ei ole käytettävissä",
  "canvas.operatingAgent.retry": "Yritä uudelleen",
