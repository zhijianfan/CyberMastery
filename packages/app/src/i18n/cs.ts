export const dict = {
  "canvas.model.refresh": "Obnovit modely",
  "canvas.model.refreshing": "Obnovování modelů…",
  "canvas.model.refresh.error": "Modely se nepodařilo obnovit. Stávající modely jsou stále k dispozici.",
  "canvas.model.picker.ariaLabel": "Výběr modelu {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Vyberte model OperatingAgent pro spuštění této relace.",
  "canvas.operatingAgent.starting": "Spouštění relace OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Relace není k dispozici",
  "canvas.operatingAgent.retry": "Zkusit znovu",
