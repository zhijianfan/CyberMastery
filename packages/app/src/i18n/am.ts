export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "የ{{label}} ሞዴል መራጭ",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "ይህን ክፍለ ጊዜ ለመጀመር የOperatingAgent ሞዴል ይምረጡ።",
  "canvas.operatingAgent.starting": "የOperatingAgent ክፍለ ጊዜ በመጀመር ላይ...",
  "canvas.operatingAgent.unavailable": "ክፍለ ጊዜው አይገኝም",
  "canvas.operatingAgent.retry": "እንደገና ሞክር",
