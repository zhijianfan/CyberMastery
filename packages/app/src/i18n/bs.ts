export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Izbornik modela za {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Odaberi OperatingAgent model da započneš ovu sesiju.",
  "canvas.operatingAgent.starting": "Pokretanje OperatingAgent sesije...",
  "canvas.operatingAgent.unavailable": "Sesija nije dostupna",
  "canvas.operatingAgent.retry": "Pokušaj ponovo",
