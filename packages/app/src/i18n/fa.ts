export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "انتخابگر مدل {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "برای شروع این جلسه، یک مدل OperatingAgent انتخاب کنید.",
  "canvas.operatingAgent.starting": "در حال شروع جلسه OperatingAgent...",
  "canvas.operatingAgent.unavailable": "جلسه در دسترس نیست",
  "canvas.operatingAgent.retry": "تلاش مجدد",
