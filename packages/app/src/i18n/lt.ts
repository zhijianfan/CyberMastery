...
export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} modelio parinkiklis",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Pasirinkite OperatingAgent modelį, kad pradėtumėte šį seansą.",
  "canvas.operatingAgent.starting": "Pradedamas OperatingAgent seansas...",
  "canvas.operatingAgent.unavailable": "Seansas nepasiekiamas",
  "canvas.operatingAgent.retry": "Bandyti dar kartą",
