export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Вибір моделі {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Виберіть модель OperatingAgent, щоб почати цю сесію.",
  "canvas.operatingAgent.starting": "Запуск сесії OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Сесія недоступна",
  "canvas.operatingAgent.retry": "Повторити спробу",
