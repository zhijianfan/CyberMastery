export const dict = {
  ...
  "canvas.model.refresh": "Actualiser les modèles",
  "canvas.model.refreshing": "Actualisation des modèles…",
  "canvas.model.refresh.error": "Impossible d’actualiser les modèles. Les modèles existants restent disponibles.",
  "canvas.model.picker.ariaLabel": "Sélecteur de modèle {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Sélectionnez un modèle OperatingAgent pour démarrer cette session.",
  "canvas.operatingAgent.starting": "Démarrage de la session OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Session indisponible",
  "canvas.operatingAgent.retry": "Réessayer",
  ...
  "workspace.environment.none.description":
    "Create a workspace to group directories, plugins, and an environment layout.",
  ...
  "canvas.ctxpack.addToDraft": "Add to CtxPack draft",
  "canvas.ctxpack.alreadyInDraft": "Already in draft",
  "canvas.ctxpack.selectionActions": "CtxPack selection actions",
  "canvas.ctxpack.saveFailed": "Unable to save this CtxPack. Try again.",
  "canvas.ctxpack.saved": "CtxPack saved",
  "canvas.ctxpack.captureFailed": "Unable to capture this response. Select a shorter passage to save as a CtxPack.",
  "canvas.scratchpad.input": "Scratchpad",
  "canvas.scratchpad.placeholder": "Write a thought…",
  "canvas.scratchpad.add": "Add thought",
  "canvas.scratchpad.messages": "Scratchpad messages",
  "canvas.scratchpad.empty": "Submitted thoughts will appear here.",
  ...
  "prompt.ctxpack.pending": "Wait for context attachments to finish loading before sending.",
  "prompt.ctxpack.failed": "Context attachment failed",
  "prompt.ctxpack.preview.title": "Context attachment",
  "prompt.ctxpack.preview.loading": "Loading context attachment…",
  ...
  "canvas.ctxpack.edit.title": "Title",
  "canvas.ctxpack.edit.keywords": "Keywords",
  "canvas.ctxpack.edit.keywordsPlaceholder": "Separate keywords with commas",
  "canvas.ctxpack.edit.sensitivity": "Pack sensitivity",
  "canvas.ctxpack.edit.save": "Save changes",
  "canvas.ctxpack.edit.cancel": "Cancel",
  "canvas.ctxpack.edit.patch": "Patch",
  "canvas.ctxpack.edit.patching": "Patching…",
  "canvas.ctxpack.edit.restore": "Restore",
  "canvas.ctxpack.edit.restoring": "Restoring…",
  "canvas.ctxpack.edit.delete": "Delete",
  "canvas.ctxpack.edit.removing": "Removing…",
  "canvas.ctxpack.edit.invalidTitle": "Use a title between 1 and 120 characters.",
  "canvas.ctxpack.edit.invalidKeywords": "Use up to 12 keywords, each between 1 and 48 characters.",
  "canvas.ctxpack.edit.conflict": "This pack changed. Reload its latest metadata before saving again.",
  "canvas.ctxpack.edit.failed": "Could not update this pack. Your changes have been kept. Try again.",
  "canvas.ctxpack.sensitivity.public": "public",
  "canvas.ctxpack.sensitivity.workspace": "workspace",
  "canvas.ctxpack.sensitivity.private": "private",
  "canvas.session.models.error": "Could not apply the workspace models. Try sending again.",
  "canvas.model.subagent": "Subagent",
  "canvas.session.reset": "Reset session",
  "canvas.chat.operating.purpose": "Workspace operations",
  "canvas.chat.operating.title": "What needs organizing?",
  "canvas.chat.operating.empty": "Manage this workspace and its blocks. Attach context when you need it.",
  "canvas.chat.operating.placeholder": "Ask about this workspace…",
  "canvas.chat.master.purpose": "Task coordination",
  "canvas.chat.master.title": "What are we building?",
  "canvas.chat.master.empty": "Describe a goal, coordinate the work, and follow task progress here.",
  "canvas.chat.master.placeholder": "Describe a task or steer the work…",
  "canvas.chat.master.execute": "Execute plan",
  "canvas.chat.master.planAttached": "ParallelPlan attached",
  "canvas.chat.master.executePrompt":
    "Execute the attached ParallelPlan context packs. Coordinate independent tasks in parallel, honor task dependencies, and report progress and results.",
  "settings.providers.chatRelay.title": "ChatRelay",
  "settings.providers.chatRelay.description":
    "Sign in to the regular ChatGPT website once. ChatRelay then opens an owned browser tab for each block and shows its replies. OpenCode does not send these messages through Codex or the OpenAI API.",
  "settings.providers.chatRelay.loginInstruction":
    "Sign in in the browser window, then close that window to connect ChatRelay.",
  "settings.providers.chatRelay.provider": "ChatGPT website",
  "settings.providers.chatRelay.connect": "Connect ChatGPT",
  "settings.providers.chatRelay.open": "Open sign-in browser",
  "settings.providers.chatRelay.refresh": "Check again",
  "settings.providers.chatRelay.retry": "Retry",
  "settings.providers.chatRelay.working": "Opening…",
  "settings.providers.chatRelay.status.disconnected": "Not connected",
  "settings.providers.chatRelay.status.opening": "Opening",
  "settings.providers.chatRelay.status.login-required": "Sign-in required",
  "settings.providers.chatRelay.status.ready": "Ready",
  "settings.providers.chatRelay.status.error": "Error",
  "provider.connect.method.unavailable": "This sign-in method is unavailable on this server.",
  "canvas.chat.relay.purpose": "ChatRelay conversation",
  "canvas.chat.relay.title": "Start a conversation",
  "canvas.chat.relay.empty": "Send a message through this relay. This conversation belongs to this block.",
  "canvas.chat.relay.placeholder": "Write a message…",
  "canvas.chat.relay.open": "Open tab",
  "canvas.chat.relay.reset": "New chat",
  "canvas.chat.relay.send": "Send",
  "canvas.chat.relay.retry": "Retry",
  "canvas.chat.relay.sending": "Sending…",
  "canvas.chat.relay.thinking": "ChatGPT is replying…",
  "canvas.chat.relay.model": "Model",
  "canvas.chat.relay.effort": "Reasoning effort",
  "canvas.chat.relay.refreshOptions": "Refresh options",
  "canvas.chat.relay.readingOptions": "Reading webpage options…",
  "canvas.chat.relay.optionsPending": "Refresh options when ChatGPT is ready.",
  "canvas.chat.relay.attachingCtxPack": "Attaching CtxPack…",
  "canvas.chat.relay.ctxpackHint": "Drop a CtxPack here, or use Attach to focused input in Context Packs.",
  "canvas.chat.relay.optionsUnavailable": "Webpage options are unavailable. Open the tab or refresh to try again.",
  "canvas.chat.relay.tabUnavailable": "This ChatGPT tab is unavailable. Start a new chat and try again.",
  "canvas.chat.relay.role.user": "You",
  "canvas.chat.relay.role.assistant": "ChatGPT",
  "canvas.chat.relay.status.disconnected": "ChatGPT disconnected",
  "canvas.chat.relay.status.opening": "Opening ChatGPT",
  "canvas.chat.relay.status.login-required": "Sign-in required",
  "canvas.chat.relay.status.idle": "ChatGPT ready",
  "canvas.chat.relay.status.thinking": "ChatGPT replying",
  "canvas.chat.relay.status.error": "ChatRelay error",
  "canvas.chat.relay.status.closed": "ChatGPT tab closed",
  "canvas.chat.relay.disconnected.title": "Connect ChatGPT in Settings",
  "canvas.chat.relay.disconnected.description":
    "Open Provider settings and connect the ChatGPT website before sending a message.",
  "canvas.chat.relay.opening.title": "Opening ChatGPT",
  "canvas.chat.relay.opening.description": "Your browser tab is being prepared.",
  "canvas.chat.relay.loginRequired.title": "Finish signing in to ChatGPT",
  "canvas.chat.relay.loginRequired.description":
    "Sign in in the browser window, then close that window to connect ChatRelay.",
  "canvas.chat.relay.handoff.denied.title": "Permission denied",
  "canvas.chat.relay.handoff.denied.description":
    "This block cannot access its ChatGPT browser connection. Check server access and try again.",
  "canvas.chat.relay.loading.title": "Preparing ChatGPT",
  "canvas.chat.relay.loading.description": "Opening the browser tab owned by this block.",
  "canvas.chat.relay.unavailable.title": "ChatRelay unavailable",
  "canvas.chat.relay.unavailable.description": "Reload the block or check the ChatGPT connection in Settings.",
  "canvas.chat.relay.error.title": "ChatRelay unavailable",
  "canvas.chat.relay.error.description": "The ChatGPT browser could not be reached. Retry initialization.",
  "canvas.chat.ready": "Ready",
  "canvas.chat.working": "Working",
  "canvas.chat.attention": "Needs input",
  "canvas.chat.history": "Load earlier messages",
  "canvas.chat.tasks": "Task progress",
  "canvas.session.reset.error": "Reset failed: {{error}}",
  "canvas.operatingAgent.reset": "Reset OperatingChat session",
  "provider.connect.oauth.browser.open": "Sign in through your browser",
}
