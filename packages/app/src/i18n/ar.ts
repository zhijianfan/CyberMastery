export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "منتقي نموذج {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "اختر نموذج OperatingAgent لبدء هذه الجلسة.",
  "canvas.operatingAgent.starting": "جارٍ بدء جلسة OperatingAgent...",
  "canvas.operatingAgent.unavailable": "الجلسة غير متاحة",
  "canvas.operatingAgent.retry": "إعادة المحاولة",
