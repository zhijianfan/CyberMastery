export const dict = {
  ...
  "canvas.model.refresh": "Rifresko modelet",
  "canvas.model.refreshing": "Po rifreskohen modelet…",
  "canvas.model.refresh.error": "Nuk u arrit të rifreskohen modelet. Modelet ekzistuese janë ende të disponueshme.",
  "canvas.model.picker.ariaLabel": "Përzgjedhësi i modelit për {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Zgjidhni një model OperatingAgent për të nisur këtë sesion.",
  "canvas.operatingAgent.starting": "Po niset sesioni OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Sesioni i padisponueshëm",
  "canvas.operatingAgent.retry": "Riprovo",
