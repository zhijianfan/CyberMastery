...
export const dict = {
  ...
  "canvas.model.refresh": "刷新模型",
  "canvas.model.refreshing": "正在刷新模型…",
  "canvas.model.refresh.error": "无法刷新模型。现有模型仍然可用。",
  "canvas.model.picker.ariaLabel": "{{label}} 模型选择器",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "选择一个 OperatingAgent 模型以开始此会话。",
  "canvas.operatingAgent.starting": "正在启动 OperatingAgent 会话...",
  "canvas.operatingAgent.unavailable": "会话不可用",
  "canvas.operatingAgent.retry": "重试",
