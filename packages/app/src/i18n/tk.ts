export const dict = {
  ...
  "canvas.model.refresh": "Modelleri täzele",
  "canvas.model.refreshing": "Modeller täzelenýär…",
  "canvas.model.refresh.error": "Modelleri täzelemek başartmady. Bar bolan modeller henizem elýeterli.",
  "canvas.model.picker.ariaLabel": "{{label}} model saýlaýjysy",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Bu sessiýany başlatmak üçin OperatingAgent modelini saýlaň.",
  "canvas.operatingAgent.starting": "OperatingAgent sessiýasy başlaýar...",
  "canvas.operatingAgent.unavailable": "Sessiýa elýeterli däl",
  "canvas.operatingAgent.retry": "Gaýtadan synanyşyň",
