export const dict = {
  ...
  "canvas.model.refresh": "Actualizar modelos",
  "canvas.model.refreshing": "Actualizando modelos…",
  "canvas.model.refresh.error": "No se pudieron actualizar los modelos. Los modelos existentes siguen disponibles.",
  "canvas.model.picker.ariaLabel": "Selector de modelos de {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Selecciona un modelo de OperatingAgent para iniciar esta sesión.",
  "canvas.operatingAgent.starting": "Iniciando la sesión de OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Sesión no disponible",
  "canvas.operatingAgent.retry": "Reintentar",
