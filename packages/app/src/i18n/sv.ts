export const dict = {
  "canvas.model.refresh": "Uppdatera modeller",
  "canvas.model.refreshing": "Uppdaterar modeller…",
  "canvas.model.refresh.error":
    "Det gick inte att uppdatera modellerna. Befintliga modeller är fortfarande tillgängliga.",
  "canvas.model.picker.ariaLabel": "Modellväljare för {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Välj en OperatingAgent-modell för att starta den här sessionen.",
  "canvas.operatingAgent.starting": "Startar OperatingAgent-session...",
  "canvas.operatingAgent.unavailable": "Sessionen är inte tillgänglig",
  "canvas.operatingAgent.retry": "Försök igen",
