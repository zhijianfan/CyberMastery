...
export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} modellválasztó",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Válasszon OperatingAgent-modellt a munkamenet indításához.",
  "canvas.operatingAgent.starting": "OperatingAgent-munkamenet indítása...",
  "canvas.operatingAgent.unavailable": "A munkamenet nem érhető el",
  "canvas.operatingAgent.retry": "Újrapróbálkozás",
