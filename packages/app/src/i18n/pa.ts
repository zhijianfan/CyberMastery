export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}} ماڈل سلیکٹر",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "ایہ سیشن شروع کرن لئی اک OperatingAgent ماڈل چنو۔",
  "canvas.operatingAgent.starting": "OperatingAgent سیشن شروع ہو رہیا اے...",
  "canvas.operatingAgent.unavailable": "سیشن دستیاب نئیں",
  "canvas.operatingAgent.retry": "دوبارہ کوشش کرو",
