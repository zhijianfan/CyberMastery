export const dict = {
  ...
  "canvas.model.refresh.error":
    "މޮޑެލްތައް ރިފްރެޝް ކުރެވެން ނުކުޅެއެވެ. މިހާރު ހުރި މޮޑެލްތައް އަދިވެސް ލިބެން ހުރެއެވެ.",
  "canvas.model.picker.ariaLabel": "{{label}} މޮޑެލް ޕިކަރ",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "މި ސެޝަން ފަށަން OperatingAgent މޮޑެލެއް ހޮވާށެވެ.",
  "canvas.operatingAgent.starting": "OperatingAgent ސެޝަން ފަށަނީ...",
  "canvas.operatingAgent.unavailable": "ސެޝަން ނުލިބެއެވެ",
  "canvas.operatingAgent.retry": "އަލުން ޓްރައި ކުރޭ",
