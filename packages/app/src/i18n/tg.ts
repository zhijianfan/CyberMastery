export const dict = {
  ...
  "canvas.model.refresh": "Навсозии моделҳо",
  "canvas.model.refreshing": "Моделҳо нав карда мешаванд…",
  "canvas.model.refresh.error": "Моделҳоро нав кардан муяссар нашуд. Моделҳои мавҷуда ҳамоно дастрасанд.",
  "canvas.model.picker.ariaLabel": "Интихобкунандаи модели {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Барои оғоз кардани ин сессия модели OperatingAgent-ро интихоб кунед.",
  "canvas.operatingAgent.starting": "Сессияи OperatingAgent оғоз мешавад...",
  "canvas.operatingAgent.unavailable": "Сессия дастрас нест",
  "canvas.operatingAgent.retry": "Аз нав кӯшиш кунед",
