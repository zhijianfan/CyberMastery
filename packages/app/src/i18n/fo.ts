export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "{{label}}-módelveljari",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Vel eitt OperatingAgent-módel fyri at byrja hesa setuna.",
  "canvas.operatingAgent.starting": "Byrjar OperatingAgent-setu...",
  "canvas.operatingAgent.unavailable": "Setan er ikki tøk",
  "canvas.operatingAgent.retry": "Royn aftur",
