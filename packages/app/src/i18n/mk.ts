export const dict = {
  ...
  "canvas.model.refresh": "Освежи модели",
  "canvas.model.refreshing": "Се освежуваат модели…",
  "canvas.model.refresh.error": "Не можевме да ги освежиме моделите. Постојните модели сè уште се достапни.",
  "canvas.model.picker.ariaLabel": "Избирач на модели за {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Изберете модел за OperatingAgent за да ја започнете оваа сесија.",
  "canvas.operatingAgent.starting": "Се стартува сесија на OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Сесијата е недостапна",
  "canvas.operatingAgent.retry": "Обидете се повторно",
