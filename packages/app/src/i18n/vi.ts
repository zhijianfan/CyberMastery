export const dict = {
  ...
  "canvas.model.picker.ariaLabel": "Bộ chọn mô hình {{label}}",
  "canvas.operatingAgent.label": "OperatingAgent",
  "canvas.operatingAgent.unconfigured": "Chọn một mô hình OperatingAgent để bắt đầu phiên này.",
  "canvas.operatingAgent.starting": "Đang bắt đầu phiên OperatingAgent...",
  "canvas.operatingAgent.unavailable": "Phiên không khả dụng",
  "canvas.operatingAgent.retry": "Thử lại",
