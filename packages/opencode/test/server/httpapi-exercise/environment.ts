...
const tempDirectory = realpathSync.native(process.env.TMPDIR ? path.resolve(process.env.TMPDIR) : tmpdir())
...
export const exerciseGlobalRoot =
  ...
  path.join(tempDirectory, `opencode-httpapi-global-${process.pid}`)
...
export const exerciseDatabasePath =
  ...
  path.join(tempDirectory, `opencode-httpapi-exercise-${process.pid}.db`)
